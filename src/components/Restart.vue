...
<template>
  <div class="flex flex-col items-center justify-center h-screen mx-auto text-gray-700 w/11-12">
    <div class="flex flex-col items-center pb-20">
      <h1 class="mb-8 text-lg font-medium text-center">
        You got {{ store.score }} out of {{ store.questionCount }} questions
        right.
      </h1>
      <button @click="store.restartQuiz()"
        class="px-12 py-4 transition bg-gray-200 rounded-lg md:text-lg hover:bg-gray-300">
        <div class="flex items-center">
          <span class="mr-3">Restart quiz</span><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
            fill-rule="evenodd" clip-rule="evenodd" fill="#444">
            <path
